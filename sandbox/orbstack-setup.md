...
### With AWB (Agent Workbench)

Configure AWB to use the sandbox:

```bash
export CLAUDE_BIN="orb run sandbox -- claude"
awb
```
...
```bash
orb run sandbox -- claude --dangerously-skip-permissions /Users/you/projects/myapp
```

Or mount specific directories:

```bash
orb config set sandbox volumes '/Users/you/projects:/projects'
