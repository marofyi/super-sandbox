 ...
 * pnpm --filter @research/browserless screenshot https://example.com --output ./screenshots
 *
 * # Specific viewport
 * pnpm --filter @research/browserless screenshot https://example.com --width 375 --height 667
 * ```
 */
